...
При работе в двух ветках одновременно может возникнуть ситуация, когда разные правки были внесены в один и тотже блок текста. При слиянии Git сообщит о конфликте и предложит выбрать и записатьнужные изменения.
