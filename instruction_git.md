...
Если ветка не нужна ее можно удалить командой:

    git branch -d <name_new_branch>
### Конфликт изменений

При работе с двумя ветками одновременно может возникнуть ситуация, когда внесены разные изменения в один и тот же блок текста. При слиянии Git сообщит о конфликте и предложит выбрать, какие же изменения записать(или оставить оба). 
### Визуализация всех веток

Для отображения коммитов в виде дерева используется команда:
